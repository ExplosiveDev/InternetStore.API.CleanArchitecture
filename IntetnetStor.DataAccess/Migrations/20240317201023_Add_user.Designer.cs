...
namespace IntetnetStore.DataAccess.Migrations
{
    ...
    [Migration("20240317201023_Add_user")]
            ...
            modelBuilder.Entity("InternetStore.DataAccess.Entities.ProductEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8790f3be-c552-4488-9ae1-43b9cd23d00c"),
                        ...
                        new
                        {
                            Id = new Guid("4603e33d-fe31-4106-a5ff-dcb1a071bc3e"),
                            CategoryId = new Guid("b61decb4-84d9-4057-b1e4-d7fb612d1d8f"),
                            Count = 1,
                        ...
                        new
                        {
                            Id = new Guid("edbeecb6-b328-418c-97dd-8441525be943"),
                            CategoryId = new Guid("b61decb4-84d9-4057-b1e4-d7fb612d1d8f"),
                            Count = 1,
                        ...
                        new
                        {
                            Id = new Guid("ea498a86-dcdb-4347-85f1-5b4e2500341f"),
